...
"""
from PyQt6.QtCore import QAbstractNativeEventFilter, QAbstractEventDispatcher, pyqtSlot
...
class QtKeyBinder:
    ...
    def unregister_hotkey(self, hotkey: str) -> None:
        ...
        # If win_id is None, silently do nothing since there's nothing to unregister